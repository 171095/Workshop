...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { assignment_id: @problem.assignment_id, question: @problem.question } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { assignment_id: @problem.assignment_id, question: @problem.question } }
