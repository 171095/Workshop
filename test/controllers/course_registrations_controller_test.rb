...
class CourseRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_registration" do
    assert_difference('CourseRegistration.count') do
      post course_registrations_url, params: { course_registration: { contact: @course_registration.contact, course_id: @course_registration.course_id, email: @course_registration.email, first_name: @course_registration.first_name, last_name: @course_registration.last_name } }
    end
  ...
  test "should update course_registration" do
    patch course_registration_url(@course_registration), params: { course_registration: { contact: @course_registration.contact, course_id: @course_registration.course_id, email: @course_registration.email, first_name: @course_registration.first_name, last_name: @course_registration.last_name } }
