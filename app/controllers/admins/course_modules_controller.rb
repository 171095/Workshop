class Admins::CourseModulesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_module.save
        format.html { redirect_to admins_course_module_path(@course_module), notice: 'Course module was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @course_module.update(course_module_params)
        format.html { redirect_to admins_course_module_path(@course_module), notice: 'Course module was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_course_modules_url, notice: 'Course module was successfully destroyed.' }
  ...
  private
    ...
    def course_module_params
      params.require(:course_module).permit(:name, :description, :course_id)
    end
end
